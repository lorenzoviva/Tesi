...
with tf.Session() as sess:
    ...
    while episode_number <= 5000:
        ...
        if drawFromModel == False:
            ...
            observation, reward, done = stepModel(sess, x_stack, action)
        ...
        if done:
            ...
            if switch_point + batch_size == episode_number:
                ...
                if drawFromModel == False:
                    print('World Perf: Episode {:d}. Reward  {:f}. action: {} mean reward  {}.'.format(real_episodes,reward_sum/real_bs,str(action), str(running_reward/real_bs)))
