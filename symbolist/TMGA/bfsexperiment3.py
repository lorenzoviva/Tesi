import bfsstructurecopy7 as bfsstructure
...
# nonsense operation
# input_tapes = [Tape(None, None, input_text="22"), Tape(None, None, input_text="41"), Tape(None, None,  input_text="24")]
...
architecture = bfsstructure.Architecture(input_tapes, output_tapes)
architecture.run()