...
bb = ".<'.>'.,.-'.+'.,"
a1 = bfsstructure.Architecture.from_str(".<'.>'.,.-'.+'.,", input_tapes, output_tapes, bb)
a1.run()
a2 = bfsstructure.Architecture.from_str(".<'.>'.,.-'.+'.,", input_tapes2, output_tapes2, bb)
a2.run()
h_architecture = bfsstructure.Architecture(input_tapes1, output_tapes1, None, horizontal=[a2, a1])
h_architecture.run()
