...
class Interpreter:
    ...
    def add(self, code, input_tape, target_tape, max_levels, level):
        ...
        self.current_tapes.append(input_tape)
        self.ground_tapes = input_tape
    ...
    def decrease_level(self):
        ...
        if self.level > 0:
            self.unfocus_tape()
            if self.level == 1:
                self.tapes[0] = Tape(None, None, other_tape=self.ground_tapes)  # if we are going to operate on level 0 we reset it to input tape
    ...
    def print_situation(self):
        print("#######################################################")
        print("\033[1;34;48m " + str(self.ground_tapes) + "\033[0m\t\t\033[1;32;48m " + str(self.target_tape) + "\033[0m\t\033[1;31;48m" + str(self.error_tape) + "\033[0m\t\t\033[1;34;48m " + str(self.tapes[0].get_list()) + "\033[0m\t\t\033[1;31;48m " + str(self.error_tape.get_list()) + "\033[0m")
        print("-------------------------------------------------------")
        i = 0
