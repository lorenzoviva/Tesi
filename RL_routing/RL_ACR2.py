...
class Policy(nn.Module):
    ...
    def __init__(self):
        ...
        # actor's layer
        self.action_head = nn.Linear(16, 128) # 1

        # critic's layer
        self.value_head = nn.Linear(16, 32) # 1

        self.state_action_routing = nn.Sequential(
            Routing(d_cov=1, d_inp=4, d_out=16, n_out=8), # 32 capsules = (1x4) --> 8 capsules = (1x4)
            Routing(d_cov=1, d_inp=16, d_out=2, n_inp=8, n_out=2), # 8 capsules (1x4) --> n_out capsules (1x2)
        )
