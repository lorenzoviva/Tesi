...
policy_net = RoutingModel(2, 64, 5).cuda(device) # RoutingLayer(screen_height, screen_width, n_actions).to(device)
target_net = RoutingModel(2, 64, 5).cuda(device) # RoutingLayer(screen_height, screen_width, n_actions).to(device)
