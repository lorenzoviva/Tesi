...
class Policy(nn.Module):
    ...
    def __init__(self):
        ...
        self.affine1 = nn.Linear(4, 4)


        # critic's layer
        self.value_head = nn.Linear(4, 1) # 1
        ...
        # self.state_action_routing = nn.Sequential(
        #     Routing(d_cov=1, d_inp=4, d_out=2, n_inp=1, n_out=2),
        #     Routing(d_cov=1, d_inp=2, d_out=2, n_inp=2, n_out=2),
        # )
    ...
    def forward(self, x):
        ...
        action_caps = x.view(x.shape[0],-1,1,4)
